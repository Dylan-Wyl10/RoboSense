...
python3 gen_od.py --timeframe 3600 --savepath 'od_file_bgv.od' --size 5 --linkflow $bgv_link
python3 gen_od.py --timeframe 3600 --savepath 'od_file_cav.od' --size 5 --linkflow $cav_link
